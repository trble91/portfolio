  ...
  return (
    <div className="landing-page">
      ...
      <div className="social-media-links">
        <a href="https://www.linkedin.com/in/daleyaaron/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
        <a href="https://github.com/trble91" target="_blank" rel="noopener noreferrer">GitHub</a>
      </div>
    </div>
  );
};
